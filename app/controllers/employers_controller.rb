class EmployersController < ApplicationController
  before_action :confirm_logged_in_employer, :except => [:new, :create, :show]
  ...
  def update
    ...
    respond_to do |format|
      if @employer.update_attributes(employer_params)
        format.html { redirect_to(edit_employer_path(@employer), :notice => 'Employer profile updated successfully.') }
